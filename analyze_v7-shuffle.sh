    ...
    do
        ...
        do
            for ((id=1;id<100;id++)); do
                ...
                lmax=1024
                capzcut=${cap}_${zcut}
                ngal_features_5fold=${DATA}/eboss/v7/ngal_features_${capzcut}_sh_${id}.hp${nside}.5r.npy
                #du -h $ngal_features_5fold
                # define out dirs
                oudir_ab=${DATA}/eboss/v7/results_${capzcut}_${nside}_sh/${id}/ablation/
                oudir_reg=${DATA}/eboss/v7/results_${capzcut}_${nside}_sh/${id}/regression/            
                ...
                do
                    ...
                    mpirun -np 8 python $ablation --data $ngal_features_5fold \
