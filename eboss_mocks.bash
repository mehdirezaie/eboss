...
do 
  ...
  do
      ...
      if [ ${cont} == "null" ]
      then
          galcat=/B/Shared/mehdi/eboss/mocks/${versiono}/NGC_${imock}_${cont}/EZmock_eBOSS_QSO_NGC_${version}_${imock}.dat.fits
      ...
      ouname=/B/Shared/mehdi/eboss/mocks/${versiono}/NGC_${imock}_${cont}/pk_${tag}_${cont}_${nmesh}_${zlim}.json
      echo $ouname
      ...
      do
           ...
           do
               ...
               galcat=/B/Shared/mehdi/eboss/mocks/${versiono}/NGC_${imock}_${cont}/EZmock_eBOSS_${tag}.dat.fits
               rancat=${galcat/.dat./.ran.}
               ouname=/B/Shared/mehdi/eboss/mocks/${versiono}/NGC_${imock}_${cont}/pk_${tag}_${cont}_${nmesh}_${zlim}.json
